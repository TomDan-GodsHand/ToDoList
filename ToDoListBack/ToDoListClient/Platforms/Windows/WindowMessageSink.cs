...
namespace ToDoListClient.Platforms.Windows
{
    ...
    public class WindowMessageSink : IDisposable
    {
        ...
        /// <summary>
        /// Used to track whether a mouse-up event is just the aftermath of a double-click and
        /// therefore needs to be suppressed.
        /// </summary>
        private bool isDoubleClick;

        /// <summary>
        /// A delegate that processes messages of the hidden native window that receives window
        /// messages. Storing this reference makes sure we don't loose our reference to the message window.
        /// </summary>
        ...
        /// <summary>
        /// Creates a dummy instance that provides an empty pointer rather than a real window
        /// handler. <br /> Used at design time.
        /// </summary>
        ...
        private void CreateMessageWindow()
        {
            ...
            // Get the message used to indicate the taskbar has been restarted This is used to
            // re-add icons when the taskbar restarts
        ...
        /// <param name="wParam">
        /// If the version is <see cref="NotifyIconVersion.Vista" /> or higher, this parameter can
        /// be used to resolve mouse coordinates. Currently not in use.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// This method is not virtual by design. Derived classes should override <see
        /// cref="Dispose(bool)" />.
        /// </remarks>
        public void Dispose()
        {
        ...
        /// <summary>
        /// This destructor will run only if the <see cref="Dispose()" /> method does not get
        /// called. This gives this base class the opportunity to finalize.
