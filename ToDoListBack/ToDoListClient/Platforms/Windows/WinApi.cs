...
namespace ToDoListClient.Platforms.Windows
{
    ...
    internal static class WinApi
    {
        ...
        /// <summary>
        /// Gets the maximum number of milliseconds that can elapse between a first click and a
        /// second click for the OS to consider the mouse action a double-click.
        /// </summary>
        /// <returns>
        /// The maximum amount of time, in milliseconds, that can elapse between a first click and a
        /// second click for the OS to consider the mouse action a double-click.
        /// </returns>
